...
the application state, performance, alerts and many more.
...
and deliver metrics values. For our exercises, we additionally will use Prometheus as a monitoring System and additionally 
